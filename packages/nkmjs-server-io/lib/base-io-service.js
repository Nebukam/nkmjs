...
class BaseIOService extends services.ServiceBase {
        ...
        this._transceiverObserver
            ...
            .Hook(services.SIGNAL.STARTED, (p_transceiver) => {
                ...
                if (p_transceiver.id) {
                    ...
                    console.log(` ┗ ${this.constructor.name} ━ New Transceiver (${p_transceiver.id}) registered ('${p_transceiver.root}')`);
                } else {
                    console.log(` ┗ ${this.constructor.name} ━ New Transceiver (NO ID) registered ('${p_transceiver.root}')`);
                }
                if (this._starting) {
    ...
    _OnConfigurationComplete() {
        ...
        if (transceivers) {
            ...
            transceivers.forEach(t => { this.Mount(t.root, t); });
        } else {
            this._MountingComplete();
        }
    }
    ...
    Mount(p_rootPath, p_options = null) {
        ...
        newTransceiver.root = p_rootPath;
